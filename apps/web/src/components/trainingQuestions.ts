 ...
 * One reference, grouped by discovery area → scenario.
 */
...
export const trainingAreas: Area[] = [
  {
    area: "Goals",
    scenarios: [
      {
  ...
  },
  {
    ...
    scenarios: [
      {
        title: "Confident About Their Credit",
        why: "Even confident borrowers benefit from a soft pull to confirm the band and mix. Verify, don’t assume.",
        questions: [
          "Do you have a rough idea of where your credit score falls right now?",
          "Have you checked it recently, or is that more of an estimate?",
          "Any accounts you’ve opened or paid off in the last few months?",
          "Do you carry balances month to month, or pay them in full?",
          "Any authorized-user or joint accounts we should know about?"
        ]
      },
      {
        title: "Worried About Their Score",
        why: "A soft pull doesn’t affect the score. Reassure first, then find what’s driving the concern.",
        questions: [
          "What’s making you concerned about your credit right now?",
          "Have you had any late payments or collections in the last couple of years?",
          "Roughly how much credit-card balance are you carrying versus your limits?",
          "Are there any accounts in dispute, or errors you’re aware of?",
          "Would it help to know this is a soft pull with no impact on your score?"
        ]
      },
      {
        title: "Past Credit Events",
        why: "Bankruptcies, foreclosures, and short sales have waiting periods. Get the date and resolution to set expectations.",
        questions: [
          "Have you had a bankruptcy, foreclosure, or short sale — and roughly when?",
          "Has everything been discharged, resolved, or brought current since then?",
          "Were there specific circumstances behind it — medical, job loss, divorce?",
          "Have you re-established credit since then with any new accounts?",
          "Are there any judgments, liens, or collections still outstanding?"
        ]
      },
      {
        title: "Hesitant About the Pull",
        why: "Objection, not a dead end. Explain the soft pull, then offer to run income and assets first and circle back.",
        questions: [
          "Is the concern the score impact, your privacy, or just not wanting to start an application yet?",
          "Would it help to know we only pull a soft copy — no inquiry, no score impact?",
          "Are you comfortable if we run through income and assets first and circle back to credit?",
          "Is there anything on your report you’re worried I’ll see that we should talk through?",
          "Once you see the range you’re in, would you be open to pulling it so we can match the right program?"
        ]
      }
    ]
  }
